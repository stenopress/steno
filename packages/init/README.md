...
generated project pins `@steno/steno` to `^0.13.0` and official themes to `^0.13.0` by default;
...
Each is pinned to `^0.13.0` unless overridden. You can also pass any `jsr:`/`npm:`/HTTPS package as
