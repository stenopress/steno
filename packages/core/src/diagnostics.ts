...
export class DiagnosticBag {
  ...
  /** Appends a diagnostic in discovery order. */
  add(diagnostic: Diagnostic): void {
    this.items.push(diagnostic);
  }

  /** All collected diagnostics in discovery order. */
  get all(): readonly Diagnostic[] {
    return this.items;
  }

  /** Diagnostics that prevent a production build. */
  ...
  /** Whether any fatal diagnostic has been collected. */
